# CLAUDE.md — BACKUP (pre-split)

This is a backup of the original monolithic CLAUDE.md before it was split into topic files.
The live version is now `CLAUDE.md` (lean index) + `Claude/` folder (topic docs).
